package com.kdg.recipe.bootstrap;

import com.kdg.recipe.domains.*;
import com.kdg.recipe.repositories.CategoryRepository;
import com.kdg.recipe.repositories.RecipeRepository;
import com.kdg.recipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setSource("Online Blog");
        guacRecipe.setUrl("http://cooking.com/Perfect-Guacamole");
